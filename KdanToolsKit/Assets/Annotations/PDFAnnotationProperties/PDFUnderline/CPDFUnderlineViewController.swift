//
//  CPDFUnderlineViewController.swift
//  ComPDFKit_Tools
//
...
@objc protocol CPDFUnderlineViewControllerDelegate: AnyObject {
    @objc optional func underlineViewController(_ underlineViewController: CPDFUnderlineViewController, annotStyle: CAnnotStyle)
}

class CPDFUnderlineViewController: CPDFAnnotationBaseViewController {
    weak var delegate: CPDFUnderlineViewControllerDelegate?
    ...
    override func commomInitTitle() {
        titleLabel?.text = NSLocalizedString("Underline", comment: "")
    ...
    override func selectColorView(_ select: CPDFColorSelectView, color: UIColor) {
        ...
        if annotStyle != nil {
            delegate?.underlineViewController?(self, annotStyle: annotStyle!)
        }
