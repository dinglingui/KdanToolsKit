...
class CPDFThumbnailViewCell: UICollectionViewCell {
    ...
    override func layoutSubviews() {
        ...
        let startW = textLabel?.text?.size(withAttributes: [.font: UIFont.systemFont(ofSize: 10)]).width ?? 0
