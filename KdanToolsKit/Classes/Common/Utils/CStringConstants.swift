...
// Annotation
   ...
   let CFreeTextNoteFontNameKey = "CFreeTextNoteFontName"
...
// Content Editor
    ...
    let CPDFContentEditTextCreateFontNameKey = "CPDFContentEditTextCreateFontName"
    let CPDFContentEditTextCreateFontIsBoldKey = "CPDFContentEditTextCreateFontIsBold"
    let CPDFContentEditTextCreateFontIsItalicKey = "CPDFContentEditTextCreateFontIsItalic"
...
// Forms
    ...
    let CTextFieldIsBoldKey = "CTextFieldIsBold"
    let CTextFieldIsItalicKey = "CTextFieldIsItalic"
    let CTextFieldAlignmentKey = "CTextFieldAlignment"
    let CTextFieldFontNameKey = "CTextFieldFontName"
    ...
    let CListBoxIsBoldKey = "CListBoxIsBold"
    let CListBoxIsItalicKey = "CListBoxIsItalic"
    let CListBoxFontNameKey = "CListBoxFontName"
    ...
    let CComboBoxIsBoldKey = "CComboBoxIsBold"
    let CComboBoxIsItalicKey = "CComboBoxIsItalic"
    let CComboBoxFontNameKey = "CComboBoxFontName"
    ...
    let CPushButtonIsBoldKey = "CPushButtonIsBold"
    let CPushButtonIsItalicKey = "CPushButtonIsItalic"
    let CPushButtonFontNameKey = "CPushButtonFontName"
